...
It looks like "IT" is the horror movie that made the most money but since on the first line of codes list theres movies there that aren't really scary and more on the thriller side,i then did a second exploration and filtered the data by the horror genre and found that the scariest movie that made the most money in that genre is "The Exorcist".
